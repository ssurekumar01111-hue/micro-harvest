            ...
            child: Column(
              ...
              children: [
                Container(
                  ...
                  child: Column(
                    children: [
                      Text('GPS Verification', style: AppTextStyles.titleLarge.copyWith(color: AppColors.wheat)),
                      ...
                      const Row(
                        ...
                        children: [
                          ...
                          SizedBox(width: 8),
                          Text('Within 500m of plot', style: TextStyle(color: AppColors.moss, fontSize: 12)),
                        ],
                      ),
                    ],
                  ),
